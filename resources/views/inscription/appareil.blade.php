<div class="col-xs-10 offset-xs-1">
    <div class="card">
        <div class="card-header">
            <strong>Informations</strong> sur l'appareil
        </div>
        <div class="card-body card-block">
                ...
                <!-- <div class="row form-group">
                    ...
                    <div class="col-12 col-md-6">
                        <p class="form-control-static" id="brandName">No brand</p>
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-6">
                        <label class=" form-control-label">Le modele</label>
                    </div>
                    <div class="col-12 col-md-6">
                ...
                <!-- <div class="row form-group">
                    <div class="col col-md-12">
                        <div class="input-group">
                            ...
                            <p class="form-control" id="smartphonePrice">0</p>
